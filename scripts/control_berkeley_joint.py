"""
scripts/control_berkeley_joint.py
...
# arm_right_shoulder_pitch_joint: hinge, range ~[-90deg, +45deg], starts well
...
ACTUATOR_NAME = "arm_right_shoulder_pitch_joint"  # motor name == joint name in this MJCF
